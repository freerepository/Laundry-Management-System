...
public class ItemGiventoDepotActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_item_givento_depots);
        ...
        findViewById(R.id.v_add_scondemned).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(ItemGiventoDepotActivity.this, ItemGiventoDepotAddActivity.class);
        ...
        srl.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                if (O.checkNetwork(ItemGiventoDepotActivity.this)) {
                    getStorList();
                } else {
    ...
    public class ItemGivenDepotadapter extends RecyclerView.Adapter<ItemGiventoDepotActivity.ViewHolder> {
        ...
        @NonNull
        @Override
        public ItemGiventoDepotActivity.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        @Override
        public void onBindViewHolder(@NonNull ItemGiventoDepotActivity.ViewHolder holder, final int pos) {
            ...
            holder.iv_view.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent=new Intent(ItemGiventoDepotActivity.this, ItemGiventoDepotListActivity.class);
            ...
            holder.iv_edit.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent=new Intent(ItemGiventoDepotActivity.this,ItemGiventoDepotUpdateActivity.class);
                    intent.putExtra("id",  list.get(position).mId);
                    startActivity(intent);
                }
            });
    ...
    public void showConfirmationDialog(String strMessage) {
        final Dialog dialog = new Dialog(ItemGiventoDepotActivity.this);
        ...
        tvOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.dismiss();
                Intent intent = new Intent(ItemGiventoDepotActivity.this, ItemGiventoDepotActivity.class);
