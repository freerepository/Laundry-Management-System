...
public class ItemReceivedFromGSDDepotActivity extends AppCompatActivity {
   ...
   ItemGivenDepotadapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_item_received_from_gsddepots);
        ...
        findViewById(R.id.v_add_scondemned).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(ItemReceivedFromGSDDepotActivity.this, ItemReceivedFromGSDDepotAddActivity.class);
        ...
        srl.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                if (O.checkNetwork(ItemReceivedFromGSDDepotActivity.this)) {
                    getStorList();
                } else {
    ...
    public class ItemGivenDepotadapter extends RecyclerView.Adapter<ItemReceivedFromGSDDepotActivity.ViewHolder> {
        ...
        @NonNull
        @Override
        public ItemReceivedFromGSDDepotActivity.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        @Override
        public void onBindViewHolder(@NonNull ItemReceivedFromGSDDepotActivity.ViewHolder holder, final int pos) {
            ...
            holder.iv_view.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent=new Intent(ItemReceivedFromGSDDepotActivity.this, ItemReceivedFromGSDDepotListActivity.class);
...
//            });
    ...
    public void showConfirmationDialog(String strMessage) {
        final Dialog dialog = new Dialog(ItemReceivedFromGSDDepotActivity.this);
        ...
        tvOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.dismiss();
                Intent intent = new Intent(ItemReceivedFromGSDDepotActivity.this, ItemReceivedFromGSDDepotActivity.class);
