...
public class ItemReceivedFromOtherPlaceActivity extends AppCompatActivity {
    private final static String get_storeReceivedData_API = "http://lmsguwahati.projectrailway.in/Api/get_storeReceivedData";

    ItemGivenDepotadapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_item_received_from_other_place);
        ...
        findViewById(R.id.v_add_scondemned).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(ItemReceivedFromOtherPlaceActivity.this, ItemReceivedFromOtherPlacesAddActivity.class);
        ...
        adapter = new ItemGivenDepotadapter(new ArrayList<>());
        ...
        srl.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                if (O.checkNetwork(ItemReceivedFromOtherPlaceActivity.this)) {
                    getStorList();
                } else {
    ...
    private void getStorList() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, get_storeReceivedData_API,
    ...
    public class ItemGivenDepotadapter extends RecyclerView.Adapter<ItemReceivedFromOtherPlaceActivity.ViewHolder> {
        ...
        @NonNull
        @Override
        public ItemReceivedFromOtherPlaceActivity.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        @Override
        public void onBindViewHolder(@NonNull ItemReceivedFromOtherPlaceActivity.ViewHolder holder, final int pos) {
            final int position=pos;
            holder.tv_serial_no.setText((position + 1) + "");
            holder.tv.setText(list.get(position).mSubmission_date);
            holder.tv1.setText(list.get(position).mReceived_from);
            ...
            holder.iv_view.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent=new Intent(ItemReceivedFromOtherPlaceActivity.this, ItemReceivedFromOtherPlaceListActivity.class);
...
//                @Override
//                public void onClick(View v) {
//                    Intent intent=new Intent(SupplyCondemnedBedSheetActivity.this,UpdateSupplyCBSActivity.class);
//                    intent.putExtra("id",  list.get(position).mId);
//                    startActivity(intent);
//                }
//            });
    ...
    public void showConfirmationDialog(String strMessage) {
        final Dialog dialog = new Dialog(ItemReceivedFromOtherPlaceActivity.this);
        ...
        tvOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.dismiss();
                Intent intent = new Intent(ItemReceivedFromOtherPlaceActivity.this, ItemReceivedFromOtherPlaceActivity.class);
