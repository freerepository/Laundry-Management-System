...
import com.example.laundrymanagementghy.LaundryActivity.CaptureAct;
...
public class QrCodeDepotActivity extends AppCompatActivity {
    private final static String update_delivery_status = "http://lmsguwahati.projectrailway.in/Api/update_depotDeliveryStatus";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_qr_code_depot);
        try {
        ...
        iv_qr_code = findViewById(R.id.qr_code_scan);
        ...
        btn_verify.setOnClickListener(new View.OnClickListener() {
            ...
            private void QrcodeVerify() {
                ...
                RequestQueue requestQueue = Volley.newRequestQueue(QrCodeDepotActivity.this);
    ...
    public void showConfirmationDialog(String strMessage) {
        final Dialog dialog = new Dialog(QrCodeDepotActivity.this);
        ...
        tvOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.dismiss();
                Intent intent = new Intent(QrCodeDepotActivity.this, QrCodeDepotActivity.class);
