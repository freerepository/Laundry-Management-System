...
import com.example.laundrymanagementghy.LaundryActivity.BufferStockIssueAddDepot;
...
public class BufferReceiptFromLaundryActivity extends AppCompatActivity {
    private final static String get_Buffer_stock_API = "http://lmsguwahati.projectrailway.in/api/getbufferStockData";
