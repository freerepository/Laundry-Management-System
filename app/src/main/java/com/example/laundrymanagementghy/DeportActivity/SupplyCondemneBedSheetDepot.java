...
import com.example.laundrymanagementghy.Bmodel.GetstoreDepotList;
...
public class SupplyCondemneBedSheetDepot extends AppCompatActivity {
    private final static String get_send_CBSDLaundry_API = "http://lmsguwahati.projectrailway.in/Api/get_SentCbdtolaundryData";
    ImageView iv_addSupply;
    TextView tv_data_not_found;
    UserDataModel userdataModel;
    RecyclerView recyclerView;
    SwipeRefreshLayout srl;
    SupplyDepotAdapter supplyDepotAdapter;
    AlertDialog dialog;
    String  id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.supply_condemne_bed_sheet_depot);
        ...
        findViewById(R.id.v_add_scondemned).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(SupplyCondemneBedSheetDepot.this, SupplyCondemnetBedSheetAddDepot.class);
        ...
        supplyDepotAdapter = new SupplyDepotAdapter(new ArrayList<>());
        recyclerView.setAdapter(supplyDepotAdapter);
        supplyDepotAdapter.notifyDataSetChanged();
        srl = findViewById(R.id.srl);
        srl.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                srl.setRefreshing(true);
                if (O.checkNetwork(SupplyCondemneBedSheetDepot.this)) {
                    getStorListDepot();
                } else {
    ...
    private void getStorListDepot() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, get_send_CBSDLaundry_API,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            GetstoreDepotList getstoreDepotList = new Gson().fromJson(response.toString(), GetstoreDepotList.class);
                            recyclerView.setAdapter(new SupplyDepotAdapter(getstoreDepotList.mList));
    ...
    public class SupplyDepotAdapter extends RecyclerView.Adapter<SupplyCondemneBedSheetDepot.ViewHolder> {
        private ArrayList<GetstoreDepotList.mDepotItem> list;

        public SupplyDepotAdapter(ArrayList<GetstoreDepotList.mDepotItem> list) {
            this.list = list;
        }

        @NonNull
        @Override
        public SupplyCondemneBedSheetDepot.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            LayoutInflater inflater = LayoutInflater.from(parent.getContext());
            View view = inflater.inflate(R.layout.row_supply_cbs_depot_list, parent, false);
            ViewHolder viewHolder = new ViewHolder(view);
            return viewHolder;
        }

        @Override
        public void onBindViewHolder(@NonNull SupplyCondemneBedSheetDepot.ViewHolder holder, final int pos) {
            ...
            holder.iv_view.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent=new Intent(SupplyCondemneBedSheetDepot.this, SupplyCondemnedSBSListDepot.class);
            ...
            holder.iv_edit.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent=new Intent(SupplyCondemneBedSheetDepot.this, SupplyCondemnetBedSheetUpdateDepot.class);
                    intent.putExtra("id",  list.get(position).mId);
                    startActivity(intent);
                }
            });
    ...
    public void showConfirmationDialog(String strMessage) {
        final Dialog dialog = new Dialog(SupplyCondemneBedSheetDepot.this);
        ...
        tvOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.dismiss();
                Intent intent = new Intent(SupplyCondemneBedSheetDepot.this, SupplyCondemneBedSheetDepot.class);
