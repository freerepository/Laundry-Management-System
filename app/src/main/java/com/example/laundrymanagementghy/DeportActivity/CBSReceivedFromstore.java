...
import com.example.laundrymanagementghy.StoreActivity.ItemGiventoDepotListActivity;
...
public class CBSReceivedFromstore extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cbs_received_fromstore);
        ...
        adapter = new CBSReceivedfstoreadapter(new ArrayList<>());
        ...
        srl.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                if (O.checkNetwork(CBSReceivedFromstore.this)) {
                    getStorList();
                } else {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            recyclerView.setAdapter(new CBSReceivedfstoreadapter(getstoreList.mList));
    ...
    public class CBSReceivedfstoreadapter extends RecyclerView.Adapter<CBSReceivedFromstore.ViewHolder> {
        private ArrayList<GetSentcbsStoreList.mStoreItem> list;

        public CBSReceivedfstoreadapter(ArrayList<GetSentcbsStoreList.mStoreItem> list) {
            this.list = list;
        }

        @NonNull
        @Override
        public CBSReceivedFromstore.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            LayoutInflater inflater = LayoutInflater.from(parent.getContext());
            View view = inflater.inflate(R.layout.row_cbs_reveived_storelist, parent, false);
            ViewHolder viewHolder = new ViewHolder(view);
            return viewHolder;
        }

        @Override
        public void onBindViewHolder(@NonNull CBSReceivedFromstore.ViewHolder holder, final int pos) {
            ...
            holder.iv_view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent=new Intent(CBSReceivedFromstore.this, ItemGiventoDepotListActivity.class);
    ...
    public void showConfirmationDialog(String strMessage) {
        final Dialog dialog = new Dialog(CBSReceivedFromstore.this);
        ...
        tvOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.dismiss();
                Intent intent = new Intent(CBSReceivedFromstore.this, CBSReceivedFromstore.class);
