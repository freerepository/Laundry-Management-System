...
import com.example.laundrymanagementghy.LaundryActivity.SupplyCondemnedSBSListActivity;
...
public class ReceivedCBSFromLaundry extends AppCompatActivity {
    ...
    ReceivedLaundryAdapter storeAdapter;
    AlertDialog dialog;
    String  id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.received_cbsfrom_laundry);
        ...
        storeAdapter = new ReceivedLaundryAdapter(new ArrayList<>());
        ...
        srl.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                if (O.checkNetwork(ReceivedCBSFromLaundry.this)) {
                    getStorList();
                } else {
    ...
    private void getStorList() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, get_CBSDepot_API,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            GetstoreList getstoreList = new Gson().fromJson(response.toString(), GetstoreList.class);
                            recyclerView.setAdapter(new ReceivedLaundryAdapter(getstoreList.mList));
    ...
    public class ReceivedLaundryAdapter extends RecyclerView.Adapter<ReceivedCBSFromLaundry.ViewHolder> {
        private ArrayList<GetstoreList.mStoreItem> list;

        public ReceivedLaundryAdapter(ArrayList<GetstoreList.mStoreItem> list) {
            this.list = list;
        }

        @NonNull
        @Override
        public ReceivedCBSFromLaundry.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            LayoutInflater inflater = LayoutInflater.from(parent.getContext());
            View view = inflater.inflate(R.layout.row_received_cbs_from_laundry_list, parent, false);
           ViewHolder viewHolder = new ViewHolder(view);
            return viewHolder;
        }

        @Override
        public void onBindViewHolder(@NonNull ReceivedCBSFromLaundry.ViewHolder holder, final int pos) {
            ...
            holder.iv_view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent=new Intent(ReceivedCBSFromLaundry.this, SupplyCondemnedSBSListActivity.class);
    ...
    public void showConfirmationDialog(String strMessage) {
        final Dialog dialog = new Dialog(ReceivedCBSFromLaundry.this);
        ...
        tvOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.dismiss();
                Intent intent = new Intent(ReceivedCBSFromLaundry.this, ReceivedCBSFromLaundry.class);
