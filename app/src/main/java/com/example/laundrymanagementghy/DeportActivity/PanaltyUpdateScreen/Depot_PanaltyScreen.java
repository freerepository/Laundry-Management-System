...
public class Depot_PanaltyScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_depot_panalty_screen);
    ...
    private void initializeViews() {
        ...
        v_add_buffer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(getApplicationContext(),Depot_PanaltyAddScreen.class));
            }
        });
...
//        });
    ...
    private void setupDatePickers(UiModeManager uiModeManager) {
        ...
        et_dateFrom.setOnClickListener(v -> {
            Calendar calendar = Calendar.getInstance();
            new DatePickerDialog(Depot_PanaltyScreen.this, journeyDateFrom, calendar.get(Calendar.YEAR),
                    calendar.get(Calendar.MONTH), calendar.get(Calendar.DAY_OF_MONTH)).show();
        });

        et_dateTo.setOnClickListener(v -> {
            Calendar calendar = Calendar.getInstance();
            DatePickerDialog dpd = new DatePickerDialog(Depot_PanaltyScreen.this, journeyDateTo,
    ...
    private void setupSwipeRefresh() {
        ...
        srl.setOnRefreshListener(() -> {
            ...
            if (O.checkNetwork(Depot_PanaltyScreen.this)) {
//                GetLaundryList();
            } else {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, STOCKDATA_list,
                response -> {
                    ...
                    try {
                        ...
                        if (adapter == null) {
                            adapter = new PanaltyAdapter(stockDataItemList,getApplicationContext());
                        ...
                        Log.e("DepotPenaltyScreen", "Parsing error: " + e.getMessage(), e);
                    } finally {
                        srl.setRefreshing(false); // Stop refreshing animation
                    }
                },
                error -> {
                    Log.e("DepotPenaltyScreen", "Error Response: " + error.getMessage(), error);
                    srl.setRefreshing(false); // Stop refreshing animation
                }) {
            @Override
            ...
            public byte[] getBody() throws AuthFailureError {
                try {
                    ...
                    Log.e("DepotPenaltyScreen", "Encoding error: " + uee.getMessage(), uee);
                    return null;
                }
            }
        };
