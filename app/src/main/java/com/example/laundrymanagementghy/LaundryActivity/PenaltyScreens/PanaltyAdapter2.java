...
public class PanaltyAdapter2 extends RecyclerView.Adapter<PanaltyAdapter2.PanaltyViewHolder> {

    Context context;
    private ArrayList<PenaltyViewModelClass.PenaltyItem> mList;
    private ArrayList<PenaltyViewModelClass.PenaltyItem> mListFull;

    public PanaltyAdapter2(ArrayList<PenaltyViewModelClass.PenaltyItem> mList, Context context) {
...
//        holder.tv_remark.setText(arrayList.get(position).remarks);
//        holder.tv_amount.setText(arrayList.get(position).amount);
//        holder.tv_view.setText(arrayList.get(position).view);
...
//        holder.tv_view.setText(item.);
        ...
        holder.tv_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, LaundryViewActivity.class);
